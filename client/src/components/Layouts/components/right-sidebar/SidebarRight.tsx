  ...
  return (
    <Sidebar collapsible='none' className='sticky top-0 hidden h-svh border-l lg:flex '>
      ...
      <SidebarContent className='w-full overflow-hidden'>
        <SidebarGroup className='w-full items-center p-2'>
      ...
      <SidebarFooter>
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton className='flex w-full active:bg-cyan-200 bg-cyan-500 text-white hover:bg-cyan-600 hover:text-white cursor-pointer transition ease all duration-200'>
              <Plus strokeWidth={2}/>
              <span className='text-xs'>Ajouter vos Date d'examen </span>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
      </SidebarFooter>
