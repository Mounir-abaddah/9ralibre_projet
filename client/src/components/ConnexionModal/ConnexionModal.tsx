      ...
      <DialogContent className="space-y-3">
        <DialogHeader className="space-y-3">
          ...
          <DialogDescription className="text-sm">
            {t("modal.noAccount")}{" "}
            <Link to="/inscription" className="border-b-2 border-b-amber-500">
              {t("modal.signUpLink")}
            </Link>
          </DialogDescription>
        ...
        <form onSubmit={handleForm} className="space-y-3">
          ...
          <div className="space-y-2">
            <Label htmlFor="Email_modal">{t("auth.fields.email")}</Label>
            <Input
              id="Email_modal"
              type="email"
          ...
          <div className="space-y-2">
            <span className="flex items-center justify-between">
              <Label htmlFor="Password_modal">{t("auth.fields.password")}</Label>
              <Link to="/password/reset" className="border-b-2 border-b-amber-500 text-xs">
          ...
          <Button
            disabled={loading}
            className="flex w-full cursor-pointer items-center space-x-2 bg-amber-500 hover:bg-amber-600"
          >
            {loading ? <Loadering /> : t("connexion.submit")}
          </Button>
        </form>
      </DialogContent>
    </Dialog>
