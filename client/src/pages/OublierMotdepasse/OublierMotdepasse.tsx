...
const OublierMotdepasse = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const response = await axios.post(`${apiUrl}/auth/oublierMotdepasse`, {
        email,
      });
          ...
          <div className="p-8">
            <form onSubmit={handleSubmit}>
              <div className="mb-6">
                <label
                  htmlFor="monemail"
                  className="mb-4 block text-base dark:text-gray-600"
                >
            ...
            <div className="text-right">
              <Link
                to="/connexion"
                className="border-b border-b-sky-400 dark:text-cyan-600"
              >
