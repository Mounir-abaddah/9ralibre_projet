...
const ProfInscription = () => {
  ...
  const handleChange = (field: string, value: string) => {
    ...
    if (field === "niveaux")
      setErrFormData((prev) => ({ ...prev, matiere: "" }));
  };
  ...
  useEffect(() => {
    ...
    const run = async () => {
      ...
      try {
        ...
        if (!cancelled)
          setMatieresList(Array.isArray(res.data) ? res.data : []);
      } catch {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.password)
      errors.password = t("prof.register.requiredPassword");
    ...
    <div className="relative flex min-h-screen items-center justify-center bg-[url('/backgorund_teacher.jpg')] bg-cover bg-no-repeat px-4">
      ...
      <div className="grid w-full max-w-5xl overflow-hidden rounded-3xl border bg-white/70 shadow-2xl backdrop-blur-xl md:grid-cols-2 dark:bg-white">
        ...
        <div className="hidden items-center justify-center bg-blue-50/50 p-6 md:flex">
          <img
            src={Teacher_img}
            alt={t("prof.register.teacherImageAlt")}
            className="max-w-md"
          />
        </div>
        ...
        <div className="flex flex-col justify-center space-y-4 p-8">
          ...
          <p className="mb-6 text-gray-500">{t("prof.register.subtitle")}</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {errorMsg && (
              ...
              >
                ...
                <AlertTitle className="text-sm font-semibold">
                  {t("prof.register.impossibleTitle")}
                </AlertTitle>
              ...
              <div className="w-full space-y-1">
                ...
                >
                  ...
                  <SelectContent>
                    <SelectGroup>
                      <SelectLabel>
                        {t("settings.fields.middleSchool")}
                      </SelectLabel>
            ...
            >
              {loading
                ? t("prof.register.creating")
                : t("prof.register.createAccount")}
            </Button>
          </form>
