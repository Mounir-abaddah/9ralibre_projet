...
const ProfChatStart = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      const convRes = await axios.get(`${apiUrl}/prof/my-conversation/${chatId}`, { withCredentials: true });
      const msgRes = await axios.get(`${apiUrl}/prof/get-messages/${chatId}`, { withCredentials: true });
      setConversation(convRes.data);
      setChat(msgRes.data);
      await axios.put(`${apiUrl}/prof/mark-as-read/${chatId}`, {}, { withCredentials: true });
    };
  ...
  return (
    <div className="flex h-[calc(100vh-64px)] overflow-hidden">
      ...
      <div className={`
        ...
        w-full shrink-0 overflow-y-auto border-r md:w-[300px]
      `}>
    <ChatProfAside />
  </div>
      {/* Chat area */}
