...
const ProfDashboard = () => {
  ...
  document.title = t("prof.dashboard.pageTitle");
          ...
          <Card className="flex flex-col-reverse items-center justify-between overflow-hidden rounded-2xl border p-4 shadow-sm sm:flex-row">
            ...
            <div className="mb-3 flex flex-shrink-0 justify-center sm:mb-0 sm:ml-4">
              <img
                ...
                alt={t("prof.dashboard.heroImageAlt")}
                loading="lazy"
          ...
          <Card className="w-full">
            <CardHeader>
              <CardTitle className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <span>{t("prof.dashboard.calendar")}</span>
            ...
            <CardContent className="pt-0">
              <p className="mb-2 text-xs font-medium text-slate-500 dark:text-slate-400">
                {t("prof.dashboard.upcomingEvents")}
              </p>

              {nextEvents.length === 0 ? (
                <p className="text-xs text-slate-500 dark:text-slate-400">
                  {t("prof.dashboard.noEvents")}
                </p>
              ) : (
